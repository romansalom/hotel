...
const Footer = () => {
  return (
    <div className="block lg:block">
      <footer class="fondoheader text-white py-3 px-4 font-sans tracking-wide">
        <div class="text-center">
          <h6 class="text-base playfair-display-letras">
            Permanece conectado con nosotros
          </h6>

          <ul class="flex flex-wrap justify-center gap-x-4 gap-4 my-3">
            <li>
