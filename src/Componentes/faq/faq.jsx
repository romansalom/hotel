...
const Faqs = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        'Es un hecho establecido hace mucho tiempo que un lector será distraído por...',
    },
    {
  ...
  return (
    <div className="mx-auto max-w-6xl p-2 rounded">
      <div className="text-center text-3xl text-green-400 mt-10 mb-10">
        <h1 className="text-4xl font-bold text-black">Preguntas Frecuentes</h1>
      </div>

      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/3 md:p-4 text-sm sticky inset-x-0 top-0 left-0 py-12">
            ...
            <div key={index} className="p-4">
              <div className="item px-6 py-2">
                ...
                >
                  <h4
                    className={
                      openIndex === index ? 'text-[#F2D6A2] font-medium' : ''
                    }
                  >
                    {item.question}
                  </h4>
